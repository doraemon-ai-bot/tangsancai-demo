# 🏺 大唐·时空幻影镜 (Tang Sancai Time Mirror)

> **数字化非遗互动装置** | 多模态穿搭感应 · 实时动作捕捉 · 盛唐三彩乐舞

《大唐·时空幻影镜》是一个结合 **AI 穿搭色彩感应** 与 **MediaPipe 实时动作捕捉** 的数字化非遗展项原型。体验者通过自身的今日穿搭（OOTD）唤醒相匹配的大唐三彩乐俑（红、蓝、黑、白、灰五大经典釉色），并通过简单的肢体动作（举左手、张双臂）开启大唐胡旋舞与釉色换装大秀。
